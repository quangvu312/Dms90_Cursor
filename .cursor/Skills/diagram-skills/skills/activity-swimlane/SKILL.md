...
Base directory for this skill: /Volumes/Data/AI4BAv2/english-ai-demo/.cursor/skills/activity-swimlane
...
```bash
.cursor/skills/activity-swimlane/render.sh docs/{feature}/srs/{feature}-{slug}-swimlane.puml --png
