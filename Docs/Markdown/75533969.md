...
| Epic |  |
| Feature |  |
| Description | Điểm bán đăng ký Chương trình có trạng thái Chờ duyệt có áp dụng quy trình duyệt, khi xem chi tiết đăng ký chương trình sẽ thấy trạng thái trung gian của phiếu đăng ký đang xử lý ở cấp nào. |
| Document version |  |
...
Màn hình Chương trình trưng bày; Thông tin đăng ký; Danh sách đã tham gia

1. Viếng thăm → Danh sách điểm bán → Thông tin điểm bán → CT trưng bày → **Danh sách đã tham gia → Thông tin đăng ký**
2. Viếng thăm → Danh sách điểm bán → Viếng thăm điểm bán → **Chương trình trưng bày → Thông tin đăng ký**
3. Viếng thăm → Danh sách điểm bán → Viếng thăm điểm bán → Thông tin điểm bán → CT trưng bày → **Danh sách đã tham gia → Thông tin đăng ký**
4. Khác →Điểm bán → Chăm sóc → **Chương trình trưng bày** → **Thông tin đăng ký**
5. Khác →Điểm bán → Chăm sóc → Thông tin điểm bán → CT trưng bày → **Danh sách đã tham gia** → **Thông tin đăng ký**
6. Khác →Điểm bán → Mở mới → Thông tin điểm bán → CT trưng bày →**Danh sách đã tham gia → Thông tin đăng ký**
...
* **Chương trình trưng bày: tại [SM-APP] Chương trình trưng bày**
