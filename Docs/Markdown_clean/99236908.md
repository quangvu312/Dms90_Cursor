...
| Epic |  |
| Feature |  |
| Description | Danh sách các dữ liệu chung áp dụng cho VG |
...
| 22 | Nguồn liên hệ | **CONTACT\_SOURCE** | *Website, Facebook, Partner Referral, Event, ERP*... |  |
| 23 | Vai trò liên hệ | **CONTACT\_ROLE** | Mua hàng, Chủ doanh nghiệp, Người nhận hàng, Quản lý... |  |
| 24 | Phân loại liên hệ | **CONTACT\_TYPE** | Bạn bè, người thân, hoặc đồng nghiệp nội bộ  Đối tác/Nhà cung cấp |  |
| 25 |  |  |  |  |
| 26 |  |  |  |  |
