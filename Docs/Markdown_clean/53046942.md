...
Khi SUP login vào App Salesman, hệ thống sẽ thực hiện kiểm tra SUP đã có thực hiện  chấm công cuối ngày ở App Quản lý hay chưa.

Nếu đã có thông tin chấm công cuối ngày, App Salesman sẽ hiển thị thông tin chấm công cuối ngày của SUP và SUP sẽ không chấm công ở App Salesman nữa
...
| Khoảng cách cho phép | Khoảng cách tối đa cho phép để nhân viên được phép chấm công, ví dụ: 50m Khoảng cách được cài đặt ở chức năng [[HO] Thiết lập vị trí chấm công](https://kb.finviet.com.vn/pages/viewpage.action?pageId=53045633) |
