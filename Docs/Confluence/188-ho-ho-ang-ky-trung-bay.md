...
RedV1.0.2 Thay mã nhân viên - tên nhân viên = mã tuyến - tên tuyến;
...
| **Hạn mức đăng ký** | Datacomlumn | Hiển thị hạn mức mà điểm bán đã đăng ký |
| **Số suất đăng ký** | Datacomlumn | Hiển thị số suất mà điểm bán đã đăng ký |
| **Thời gian đăng ký** | Datacomlumn | Hiển thị thời gian mà điểm bán đã thao tác đăng ký dd-mm-yyyy |
| **Hợp đồng đăng ký** | image | Hiển thị hình ảnh đăng ký của user từ app / upload ở chức năng cập nhật đăng ký |
...
| **Ngày cập nhật** | Datacomlumn | - Hiển thị thời gian mà Đăng ký được thay đổi sang các trạng thái khác  dd-mm-yyy hh:mm:ss |
...
trueUntitled Diagramfalse1500autotoptrue16831
...
| --- | --- | --- | --- | --- |
| 1 | Trạng thái đăng ký của khách hàng = **Chưa đăng ký** | Chuyển đăng ký của khách hàng sang trạng thái **Đã** **duyệt**  **Ngày đăng ký được cập nhật = Ngày import**  **Ngày duyệt đăng ký = Ngày import** | Chuyển đăng ký của khách hàng sang trạng thái **Đã** **duyệt**  **Ngày đăng ký được cập nhật = Ngày import**  **Ngày duyệt đăng ký = Ngày import** | Hiển thị thông báo: "Dòng n: Điểm bán chưa có đăng ký CTTB. Vui lòng kiểm tra lại!" |
| 2 | Trạng thái đăng ký của khách hàng = **Chờ duyệt** | **Update số suất và hạn mức đăng ký**  Chuyển đăng ký của khách hàng sang trạng thái **Đã** **duyệt**  **Ngày đăng ký giữ nguyên**  **Ngày duyệt đăng ký = Ngày import** | **Update số suất và hạn mức đăng ký**  →  Chuyển đăng ký của khách hàng sang trạng thái **Đã duyệt**  **Ngày đăng ký giữ nguyên**  **Ngày duyệt đăng ký = Ngày import** | Chuyển đăng ký của khách hàng sang trạng thái **Từ chối duyệt**  **Ngày đăng ký giữ nguyên**  **Ngày duyệt đăng ký = Ngày import** |
| 3 | Trạng thái đăng ký của khách hàng = **Đã duyệt** | **Update số suất và hạn mức đăng ký**  Giữ nguyên trạng thái **Đã** **duyệt**  **Ngày đăng ký giữ nguyên**  **Ngày duyệt đăng ký giữ** | **Update số suất và hạn mức đăng ký**  **Giữ nguyên trạng thái đăng ký Đã duyệt của khách hàng**  **Ngày đăng ký giữ nguyên**  **Ngày duyệt đăng ký giữ nguyên** | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Đã duyệt". Vui lòng kiểm tra lại!" |
| 4 | Trạng thái đăng ký của khách hàng = **Ngưng hoạt động** | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Ngưng hoạt động". Vui lòng kiểm tra lại!" | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Ngưng hoạt động". Vui lòng kiểm tra lại!" | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Ngưng hoạt động". Vui lòng kiểm tra lại!" |
| 5 | Trạng thái đăng ký của khách hàng = **Từ chối duyệt**  *Vẫn còn khung thời gian đăng ký* | Chuyển đăng ký của khách hàng sang trạng thái **Đã****duyệt**  (Case đăng ký lại trong khung đăng ký)  **Ngày đăng ký = Ngày import**  **Ngày duyệt đăng ký = Ngày import** | Chuyển đăng ký của khách hàng sang trạng thái **Đã duyệt**  (Case đăng ký lại trong khung đăng ký)  **Ngày đăng ký = Ngày import**  **Ngày duyệt đăng ký = Ngày import** | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Từ chối duyệt". Vui lòng kiểm tra lại!" |
| 6 | Trạng thái đăng ký của khách hàng = **Từ chối duyệt**  *Đã hết khung thời gian đăng ký* | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Từ chối duyệt". Vui lòng kiểm tra lại!" | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Từ chối duyệt". Vui lòng kiểm tra lại!" | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Từ chối duyệt". Vui lòng kiểm tra lại!" |

#### **CTTB có Field "Tự dộng duyệt tham gia" = OFF**

|  | Trạng thái đăng ký của khách hàng | Trạng thái import = 0  *Chờ duyệt* | Trạng thái import = 1  *Đã duyệt* | Trạng thái import = 2  *Từ chối duyệt* |
| --- | --- | --- | --- | --- |
| 1 | Trạng thái đăng ký của khách hàng = **Chưa đăng ký** | Chuyển đăng ký của khách hàng sang trạng thái **Chờ duyệt**  **Ngày đăng ký được cập nhật = Ngày import**  **Ngày duyệt đăng ký  rỗng** | Chuyển đăng ký của khách hàng sang trạng thái **Đã** **duyệt**  **Ngày đăng ký được cập nhật = Ngày import**  **Ngày duyệt đăng ký = Ngày import** | Hiển thị thông báo: "Dòng n: Điểm bán chưa có đăng ký CTTB. Vui lòng kiểm tra lại!" |
...
| 3 | Trạng thái đăng ký của khách hàng = **Đã duyệt** | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Đã duyệt". Vui lòng kiểm tra lại!" | **Update số suất và hạn mức đăng ký**  **Giữ nguyên trạng thái đăng ký Đã duyệt của khách hàng**  **Ngày đăng ký giữ nguyên**  **Ngày duyệt đăng ký giữ nguyên** | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Đã duyệt". Vui lòng kiểm tra lại!" |
| 4 | Trạng thái đăng ký của khách hàng = **Ngưng hoạt động** | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Ngưng hoạt động". Vui lòng kiểm tra lại!" | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Ngưng hoạt động". Vui lòng kiểm tra lại!" | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Ngưng hoạt động". Vui lòng kiểm tra lại!" |
| 5 | Trạng thái đăng ký của khách hàng = **Từ chối duyệt**  *Vẫn còn khung thời gian đăng ký* | Chuyển đăng ký của khách hàng sang trạng thái **Chờ duyệt**  (Case đăng ký lại trong khung đăng ký)  **Ngày đăng ký = Ngày import**  **Ngày duyệt đăng ký rỗng** | Chuyển đăng ký của khách hàng sang trạng thái **Đã duyệt**  (Case đăng ký lại trong khung đăng ký)  **Ngày đăng ký = Ngày import**  **Ngày duyệt đăng ký = Ngày import** | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Từ chối duyệt". Vui lòng kiểm tra lại!" |
| 6 | Trạng thái đăng ký của khách hàng = **Từ chối duyệt đăng ký**  *Đã hết khung thời gian đăng ký* | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Từ chối duyệt". Vui lòng kiểm tra lại!" | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Từ chối duyệt". Vui lòng kiểm tra lại!" | Hiển thị thông báo: "Dòng n: Điểm bán đã có tồn tại đăng ký khác có trạng thái "Từ chối duyệt". Vui lòng kiểm tra lại!" |
...
| 2 | RedV1.0.2Mã tuyến | Text không nhập tiếng việt, không khoảng trắng, không ký tự đặc biệt | * Nhập mã tuyến đăng ký cho điểm bán | * **Nếu không nhập:**   + Để trống: Trống 1 line => bỏ qua   + Chỉ Mã tuyến để trống: Hiển thị thông báo lỗi: "Dòng n: Mã tuyến bị bỏ trống, vui lòng kiểm tra lại!" * **Nếu có nhập:** Kiểm tra lần lượt các điều kiện:   + **Định dạng dữ liệu.** → Nhập không đúng:"Dòng n: Mã tuyến nhập không đúng định dạng. Vui lòng kiểm tra lại!"   + **Tính tồn tại và trạng thái hoạt động**.  * + - **Mã tuyến phải tồn tại và đang hoạt động trong hệ thống.**     - Nếu mã tuyến không tồn tại hoặc đã bị vô hiệu hóa:       * Hiển thị thông báo lỗi: "Dòng n: Mã tuyến không tồn tại/ không hoạt động. Vui lòng kiểm tra lại!" |
| 3 | Mã CTTB (\*) | Text không nhập tiếng việt, không khoảng trắng, không ký tự đặc biệt (Trừ dấu "."; "-"; "\_") | * Nhập mã CTTB mà điểm bán đăng ký | * Mã CTTB không tồn tại/ không hoạt động trên hệ thống DMS   + Hiển thị thông báo lỗi "Dòng n: Mã CTTB không tồn tại hoặc không hoạt động. Vui lòng kiểm tra lại!" * CTTB phải đang ở trạng thái Sắp diễn ra/Đang diễn ra.   + Hiển thị thông báo lỗi "Dòng n: Mã CTTB không nằm trong thời gian có thể đăng ký. Vui lòng kiểm tra lại!" |
| 4 | Hạn mức (\*) | Chỉ nhập số nguyên dương > 0 | * Nhập hạn mức đăng ký | * Hạn mức để trống hoặc nhập không đúng định dạng.   + Hiển thị thông báo lỗi "Dòng n: Hạn mức nhập không đúng định dạng hoặc để trống. Vui lòng kiểm tra lại!" * Hạn mức phải có trong hạn mức CTTB, nếu không:   + Hiển thị thông báo lỗi "Dòng n: Hạn mức không nằm trong hạn mức của CTTB đã nhập. Vui lòng kiểm tra lại!" |
| 5 | Số suất (\*) | Chỉ nhập số nguyên dương > 0 | * Nhập số suất đăng ký | * Số suất để trống hoặc nhập không đúng định dạng.   + Hiển thị thông báo lỗi "Dòng n: Số suất nhập không đúng định dạng hoặc để trống. Vui lòng kiểm tra lại!" * Số suất nhập trong file phải <= số suất tối đa được đăng ký của CTTB. Nếu không   + Hiển thị thông báo lỗi "Dòng n: Số suất lớn hơn số suất tối đa của CTTB đã nhập. Vui lòng kiểm tra lại!" |
| 6 | Trạng thái (\*) | Chỉ nhập các số 0, 1, 2 | Trạng thái đăng ký CTTB của khách hàng  *0: Chờ duyệt*  *1: Đã duyệt*  *2: Từ chối duyệt* | * Trạng thái để trống hoặc nhập không đúng định dạng.   + Hiển thị thông báo lỗi "Dòng n: Trạng thái nhập không đúng định dạng hoặc để trống. Vui lòng kiểm tra lại!" * Kiểm tra trạng thái đăng ký theo bảng [các case import](https://kb.finviet.com.vn/pages/viewpage.action?pageId=47448921#id-%C4%90%C4%83ngk%C3%BDCTTB(EnhanceT10)-Cac_Case_Import). |
| 7 | Lý do | text (100) | Bắt buộc khi Trạng thái đăng ký = 2 | * Lý do để trống hoặc nhập không đúng định dạng khi Trạng thái đăng ký = 2   + Hiển thị thông báo lỗi "Dòng n: Lý do nhập không đúng định dạng hoặc để trống. Vui lòng kiểm tra lại!" |
| 8 | Lưu thông tin |  |  | * Khi đã kiểm tra thỏa các điều kiện:   + Lưu thông tin đăng ký CTTB cho khách hàng   + Thông báo: Import thành công   + Ghi nhận thời gian đăng ký CTTB theo mô tả trong các case import |
...
| **Hợp đồng đăng ký** | Datacolumn hyperlink | Hiển thị hyperlink để xem hợp đồng đính kèm .pdf |
