...
# Cấu hình chấm công đầu ngày trên App SM

Sử dụng cấu hình SALESMAN\_REQUIRED\_CHECKIN\_WORKING\_TIME

Config tắt ↔  = 0: Không hiển thị chức năng chấm công đầu ngày, cuối ngày trên App salesman ↔ Báo cáo chấm công sẽ không có thông tin ngày công

Config bật ↔ = 1: Hiển thị và bắt buộc thực hiện chức năng chấm công đầu ngày, cuối ngày trên App salesman. Không chấm công đầu ngày thì sẽ không thực hiện được một số chức năng

# Chấm công đầu ngày

Lưu ý chấm công dành cho SUP

Khi SUP login vào App salesman, hệ thống sẽ thực hiện kiểm tra SUP đã có thực hiện chấm công đầu ngày ở App Quản lý hay chưa.

Nếu đã có thông tin chấm công đầu ngày, App saleman sẽ hiển thị thông tin chấm công đầu ngày của SUP và SUP sẽ không chấm công ở App salesman nữa
...
* Chọn Bắt đầu ngày công → Hệ thống sẽ mở màn hình Chấm Công Đầu Ngày.

**Trường hợp 3:** Ở chức năng [SM-APP] Lịch sử chấm công, trường hợp user đang xem thông tin lịch sử chấm công của bản thân mình ngày hiện tại. Nếu chưa thực hiện chấm công, hệ thống sẽ hiển thị như sau:
...
| --- | --- | --- |
|  | Địa điểm chấm công | Địa điểm chấm công đã được cài đặt ở chức năng [HO] Thiết lập vị trí chấm công   * Nếu config [CONFIG\_LOCATION\_WORKING\_TIME](https://kb.finviet.com.vn/pages/viewpage.action?pageId=53021846)= Off thì Vị trí chấm công = Vị trí hiện tại của thiết bị của nhân viên  * Nếu [CONFIG\_LOCATION\_WORKING\_TIME](https://kb.finviet.com.vn/pages/viewpage.action?pageId=53021846)= On   + Có thiết lập vị trí chấm công, lấy từ cài đặt [[HO] Thiết lập vị trí chấm công](https://kb.finviet.com.vn/pages/viewpage.action?pageId=53045633)   + Không thiết lập vị trí chấm công, màn hình sẽ hiển thị cảnh báo: Vị trí chấm công chưa được thiết lập, vui lòng liên hệ admin để được hỗ trợ!     - Đóng: Nhấn button quay về màn hình Home. |
...
| Khoảng cách cho phép | Khoảng cách tối đa cho phép để nhân viên được phép chấm công, ví dụ: 50m Khoảng cách được cài đặtở chức năng [HO] Thiết lập vị trí chấm công |
