...
* Chỉ thay đổi cách tính doanh số + danh sách đơn hàng phải theo theo status được chọn ở config ORDER\_STATUS\_FOR\_APP\_REPORT, các thông tin còn lại không thay đổi
* Lưu ý thông tin ngày tính doanh số = Ngày đặt hàng

RedV1.0.1: Bổ sung filter theo tuyến bán hàng

Khi vào màn hình Báo cáo doanh số ngày, 
