    ...
    bindAll(root) {
      ...
      if (!this._docBound) {
        ...
        document.addEventListener('click', (e) => {
          if (e.target.closest('[data-select], [data-multiselect], [data-treeselect-id], .dms-datepicker')) return;
        ...
        window.addEventListener('scroll', () => {
          document.querySelectorAll('.dms-select.is-open, .dms-multiselect.is-open, .dms-treeselect.is-open, .dms-datepicker.is-open').forEach((open) => {
            ...
            const drop = open.querySelector('.dms-select__dropdown, .dms-multiselect__dropdown, .dms-treeselect__dropdown, .dms-datepicker__dropdown');
    ...
    bind(el) {
      ...
      const setOpen = (open) => {
        ...
        if (open) {
          ...
          el.querySelector('.dms-select__search')?.focus();
        }
      };
